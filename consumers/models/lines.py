...
class Lines:
    ...
    def process_message(self, message):
        ...
        if "org.chicago.cta.station" in message.topic(): #My note: This may require a regex "^org.chicago.cta.station"
        #if re.search("^org.chicago.cta.station", message.topic()):
            value = message.value()
